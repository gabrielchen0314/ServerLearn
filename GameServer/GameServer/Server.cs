...
namespace GameServer
{
    class Server
    {
        ...
        public static void Start(int _maxPlayers, int _port)
        {
            ...
            Console.WriteLine($"Server started on port {s_Port}.");
        }
        ...
        private static void UDPReceiveCallback(IAsyncResult iResult)
        {
            ...
            {
                Console.WriteLine($"Error receiving UDP data: {iEx}");
            }
        }
        ...
        public static void SendUDPData(IPEndPoint iClientEndPoint,Packet iPacket)
        {
            ...
            {
                Console.WriteLine($"Error sending data to {iClientEndPoint} via UDP:{iEx}");
            }
        }
